    ...
    fun доложить(ctx: Context) {
        ...
        поток.execute {
            val json = buildString {
                ...
                /* VPN и обрыв уехали в доклад о связи (`networkBack`, мост 1.69): место их и
                   правда там. Этот отчёт отвечает на «разбудим ли», а те два факта про связь —
                   складывать их сюда значило бы сделать один отчёт про две разные темы. */
                append("}")
            }
