...
export const STORAGE_KEYS = [
  ...
  'sl.engine.clouds.v1',// что из облаков уже передано движку
  'sl.mealnames.v1',    // имена повторяющихся приёмов
  'sl.bridgealert.v1',  // порог предупреждения о разряде моста
] as const;
