...
export interface AudioSituationView {
  ...
  route: string;
  /** Держать ли звуковую опору. false в машине — иначе перехватим магнитолу. */
  holdAudioAnchor: boolean;
  /** Поднимать ли громкость ради тревоги. */
  raiseVolume: boolean;
  /** Разворачивать ли тревогу на весь экран. */
  fullScreen: boolean;
  /** Что сказать человеку, если чего-то не делаем из-за обстановки. Пусто — говорить не о чем. */
  words?: string | null;
}
