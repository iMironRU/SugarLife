...
export default function Today() {
  ...
  return (
    <Screen tab={2} panel="full">
          ...
          {dev?.suspended === true && (
            <Notice вид="сообщение" значок={pauseCircleOutline} заголовок="Помпа на паузе">
          ...
          {nightEmpty && виденРезервуар && (
            <Notice вид="предупреждение" значок={moonOutline}
          ...
          {soonEmpty && виденРезервуар && (
            <Notice вид="предупреждение" значок={warningOutline}
          ...
          {виденПодъём && (
            <Notice вид="предупреждение" значок={restaurantOutline}
          ...
          {виднаЕда && (
            <Notice вид="сообщение" значок={restaurantOutline}
          ...
          {виднаБатарея && (
            <Notice вид="предупреждение" значок={batteryDeadOutline}
          ...
          {спроситьЗаправку && заправка && (
            <Notice вид="предложение" значок={waterOutline} заголовок="Похоже, ты заправил картридж"
              действия={(
