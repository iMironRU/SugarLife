...
import { связь, источникГлюкозы, источникПомпы, связьГлюкозы, предложениеСлияния, серийникИз, своиЖелезки, видКруга, черезЧто, активныйКанал, черезЧтоСпорное, устройствоРоли, рольСнимка } from './deviceState';
