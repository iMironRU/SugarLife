...
/* Страница правки правила тревоги (#590). Открывается из списка правил, то есть уже изнутри
   «Тревог»: к этому моменту раздел загружен, и своя точка нужна только чтобы не тащить страницу
   в первый кусок. */
export const ПравилоSection = ленивый<{ ruleId: string; title: string; onClose: () => void }>(
  () => import('./тревоги/ПравилоSection'), 'Правило');
