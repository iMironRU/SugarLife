        ...
        {isNative && (
          <>
            ...
            <div className="встроенный">
              <b>Интерфейс, скачанный по воздуху, главнее того, что ставят проводом</b>
              <i>
                Пока он стоит, новый интерфейс с компьютера до вас не доедет: приложение
                поднимется из скачанного. Эта кнопка возвращает тот интерфейс, который лежит
                внутри самого приложения, и перезапускает его. Данные и настройки остаются.
              </i>
