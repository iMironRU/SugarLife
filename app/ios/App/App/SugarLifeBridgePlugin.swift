...
public class SugarLifeBridgePlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    /* Одно число на двоих со сроком годности карточки: см. ЖивойБаннерУправление.порогЧислаСек.
       Разъехавшись, они дают карточку, которая протухает раньше, чем мы её кормим (#651). */
    private var баннерЧислоНеЧащеМс: Double { ЖивойБаннерУправление.порогЧислаСек * 1000 }
